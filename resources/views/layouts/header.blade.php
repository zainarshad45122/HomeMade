  <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Food App Admin</p>
            </div>
        </div>
        <!-- ============================================================== -->
            ...
            <nav>
                <div class="nav-wrapper">
                    ...
                    <a href="javascript:void(0)" class="brand-logo">
                      <h5 style="color: white"><b>HomeMade Admin</b></h5>
                      <!--   <span class="icon">
                            <img class="light-logo" src="{{ url('assets/images/logo-light-icon.png') }}">
                            <img class="dark-logo" src="{{ url('assets/images/logo-icon.png') }}">
                        </span>
                        <span class="text">
                            <img class="light-logo" src="{{url('assets/images/logo-light-text.png') }}">
                            <img class="dark-logo" src="{{url('assets/images/logo-text.png')}}">
                        </span> -->
                    </a>
                    <!-- ============================================================== -->
                    <!-- Logo you can find that scss in header.scss -->
                            ...
                            <ul id="msg_dropdown" class="mailbox dropdown-content">
                                ...
                                <li>
                                    <div class="message-center">
                                        ...
                                        <a href="#">
                                                <span class="user-img">
                                                    <img src="{{url('assets/images/users/1.jpg')}}" alt="user" class="circle">
                                        ...
                                        <a href="#">
                                                <span class="user-img">
                                                    <img src="{{url('assets/images/users/2.jpg')}}" alt="user" class="circle">
                                        ...
                                        <a href="#">
                                                <span class="user-img">
                                                    <img src="{{url('assets/images/users/3.jpg')}}" alt="user" class="circle">
                                        ...
                                        <a href="#">
                                                <span class="user-img">
                                                    <img src="{{url('assets/images/users/4.jpg')}}" alt="user" class="circle">
            ...
            <ul id="slide-out" class="sidenav">
                <li class="side-wrap">
                    <ul class="collapsible">
                        ...
                        <li>
                            <a href="javascript: void(0);" class="collapsible-header has-arrow two-column"><i class="material-icons">person_pin</i><span class="hide-menu"> Chefs </span></a>
                            <div class="collapsible-body">
                                <ul>
                                    <li><a href="{{url('/chef/reports')}}"><i class="material-icons">assignment_ind</i><span class="hide-menu">Reported Chefs</span></a></li>
                                    <li><a href="{{url('/allchefs')}}"><i class="material-icons">assignment_ind</i><span class="hide-menu">All Chefs</span></a></li>
